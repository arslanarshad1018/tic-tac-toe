...
const TicTacToe = () => {
    ...
    const toggle =(e,num) =>{
        ...
        if(count%2===0){
            next_player.current.innerHTML="Next Player is: O"
            e.target.innerHTML=`<img src='${cross_icon}'>`;
            data[num] ='x';
            setCount(++count)
        }
        else{
            next_player.current.innerHTML=" Next Player is: X"
    ...
    const won = (winner)=>{
        ...
        if(winner ==="x"){
            ...
            titleRef.current.innerHTML="Match Tie"
  ...
  return (
    <div className='container'>
        ...
        <h1 className="title" ref={next_player}> Next Player is: X </h1>
        <div className="board">
            <div className="row1">
